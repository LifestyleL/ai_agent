...
export class CubismUserModel {
  ...
  protected _lipsync: boolean; // 是否对口型
  protected _lastLipSyncValue: number; // 最后对口型的控制区
  protected _dragX: number; // 鼠标拖动X位置
  protected _dragY: number; // 鼠标拖动的Y位置
  ...
  protected _motionConsistency: boolean; // motion3.json是否进行一致性验证
