...
from agent.agent_voice import Voice
from memory_core import MemoryCore
from llm.llm_collaborator import create_collaborator
from event.event_bus import event_bus, EventType, Event
from event.drive_model import get_drive_model  # 替换舒适度模型
from event.persona import get_persona
from event import instinct_handler  # 导入以注册事件处理器
from event import mumble_handler  # 导入嘟囔处理器
from event import autonomous_worker  # 导入自主工作者
...
class YumeDriver:
    ...
    def _setup_event_handlers(self):
        """设置事件处理器"""
        from event.event_bus import event_bus, EventType, event_handler
